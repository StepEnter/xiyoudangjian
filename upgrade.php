...
CREATE TABLE IF NOT EXISTS `ims_vlinke_cparty_param` (
  ...
  `loginmobile` tinyint(4) NOT NULL DEFAULT '0' COMMENT '学号：0不填写，1填写不验证，2填写并短信验证',
  `loginidnumber` tinyint(4) NOT NULL DEFAULT '0' COMMENT '手机号：0不填写，1填写',
  `mypic` varchar(255) NOT NULL COMMENT '个人中心背景',
  `telephone` varchar(255) NOT NULL COMMENT '联系电话',
  `aboutus` text COMMENT '关于手机号们',
...
CREATE TABLE IF NOT EXISTS `ims_vlinke_cparty_seritem` (
  ...
  `mobile` varchar(255) NOT NULL COMMENT '联系人学号',
...
CREATE TABLE IF NOT EXISTS `ims_vlinke_cparty_supmailbox` (
  ...
  `mobile` varchar(255) NOT NULL COMMENT '学号',
...
CREATE TABLE IF NOT EXISTS `ims_vlinke_cparty_user` (
  ...
  `realname` varchar(255) NOT NULL COMMENT '姓名',
  `idnumber` varchar(255) NOT NULL COMMENT '手机号',
  `mobile` varchar(255) NOT NULL COMMENT '学号',
  ...
  `origin` varchar(255) NOT NULL COMMENT '年级',
  `nation` varchar(255) NOT NULL COMMENT '专业',
...
if(!pdo_fieldexists("vlinke_cparty_param", "loginmobile")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_param")." ADD   `loginmobile` tinyint(4) NOT NULL DEFAULT '0' COMMENT '学号：0不填写，1填写不验证，2填写并短信验证';");
}
if(!pdo_fieldexists("vlinke_cparty_param", "loginidnumber")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_param")." ADD   `loginidnumber` tinyint(4) NOT NULL DEFAULT '0' COMMENT '手机号：0不填写，1填写';");
}
...
if(!pdo_fieldexists("vlinke_cparty_param", "aboutus")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_param")." ADD   `aboutus` text COMMENT '关于手机号们';");
}
...
if(!pdo_fieldexists("vlinke_cparty_seritem", "mobile")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_seritem")." ADD   `mobile` varchar(255) NOT NULL COMMENT '联系人学号';");
}
...
if(!pdo_fieldexists("vlinke_cparty_supmailbox", "mobile")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_supmailbox")." ADD   `mobile` varchar(255) NOT NULL COMMENT '学号';");
}
...
if(!pdo_fieldexists("vlinke_cparty_supproposal", "mobile")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_supproposal")." ADD   `mobile` varchar(255) NOT NULL COMMENT '学号';");
}
...
if(!pdo_fieldexists("vlinke_cparty_user", "idnumber")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_user")." ADD   `idnumber` varchar(255) NOT NULL COMMENT '手机号';");
}
if(!pdo_fieldexists("vlinke_cparty_user", "mobile")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_user")." ADD   `mobile` varchar(255) NOT NULL COMMENT '学号';");
}
...
if(!pdo_fieldexists("vlinke_cparty_user", "origin")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_user")." ADD   `origin` varchar(255) NOT NULL COMMENT '年级';");
}
if(!pdo_fieldexists("vlinke_cparty_user", "nation")) {
 pdo_query("ALTER TABLE ".tablename("vlinke_cparty_user")." ADD   `nation` varchar(255) NOT NULL COMMENT '专业';");
}
